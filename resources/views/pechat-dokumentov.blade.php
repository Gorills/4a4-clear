        ...
        <div class="container">
            <div class="section-uslugi__inner">
                ...
                <p class="mb-20">
                    ...
                    Примерно 6% тратится Вашей компании на поддержание принтеров в пригодном для печати состоянии. Наиболее надежным способом
                    экономии на печати - печать документов в больших объемах в Компании <b><?= (config('app.company')) ?></b>.
                </p>
                <p class="mb-20">
                    ...
                    цветная или черно/белая печать документов, а также печать документов формата А3 и более крупных форматов, широкоформатная печать,
                    большой тираж или разовая акция.
                </p>
                <p class="mb-20">
                    Большой выбор полиграфических услуг, быстрая печать документов, гибкая система расчета, индивидуальный расчет цены, который исходит
    ...
    <section class="section-uslugi">
        <div class="container">
            <div class="section-uslugi__inner">
                ...
                <ul>
                    <li>Оптимизация затрат. Вы не тратитесь на приобретение дорогого оборудования, не покупаете расходные материалы. В общем экономия может достигать до 70%.</li>
    ...
    <section class="section-uslugi bg-blue">
        <div class="container">
            <div class="section-uslugi__inner">
                ...
                <h2 class="section-uslugi__title">Мы печатаем документы в Томске с любых носителей</h2>

                <p class="mb-20">
                    В наших точках печати имеется специализированное оборудование, которое способно обеспечить скорость печати до нескольких десятков листов в минуту.
                    Качественно, оперативно и дешево.
                </p>

                <p>
                    К условиям партнерства можно отнести следующие пункты: срок печати, количества тиража, являетесь вы корпоративным клиентом или у Вас разовый заказ.
                    Условия партнерства выгодны и удобны как для корпоративных партнеров, так и для клиентов, заинтересованных в больших разовых заказах. Надеемся,
                    Вы найдете в лице компании <b><?= (config('app.company')) ?></b> надежного исполнителя и советчика в области полиграфии. Если тираж печатного издания составляет более 1000 экземпляров,
                    можно выбрать более экономичные виды распечатки.
